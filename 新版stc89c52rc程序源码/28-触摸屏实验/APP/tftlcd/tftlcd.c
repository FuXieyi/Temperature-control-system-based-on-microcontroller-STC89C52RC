...
#ifdef TFT18_ST7735S		
		LCD_WriteCmd(0x36);
		LCD_WriteData(0x08);//0x05	 
#endif

#ifdef TFT20_S1D1910X		
		LCD_WriteCmd(0xBC);
		LCD_WriteData(0x02);//0x05	 
#endif
...
void TFTLCD_Init(void)
{
...
#ifdef TFT20_ILI9335DS
	//---------------Anti Digital Noise---------------//
	LCD_WriteCmd(0x00f0);LCD_WriteData(0x0001);
	LCD_WriteCmd(0x00f2);LCD_WriteData(0x2010);
	LCD_WriteCmd(0x00f0);LCD_WriteData(0x0000);
	
	//---------------Start Initial Sequence---------------//
	LCD_WriteCmd(0x0002);LCD_WriteData(0x0200);
	LCD_WriteCmd(0x0004);LCD_WriteData(0x0000);
	LCD_WriteCmd(0x0008);LCD_WriteData(0x0202);
	LCD_WriteCmd(0x0009);LCD_WriteData(0x0000);
	LCD_WriteCmd(0x000A);LCD_WriteData(0x0000);
	...
	LCD_WriteCmd(0x0007);LCD_WriteData(0x0020);
	delay_ms(200);
	
	LCD_WriteCmd(0x0010);LCD_WriteData(0x1490);
	LCD_WriteCmd(0x0011);LCD_WriteData(0x0227);
	delay_ms(50);
	
	LCD_WriteCmd(0x0012);LCD_WriteData(0x008C);
	delay_ms(10);
	
	LCD_WriteCmd(0x0013);LCD_WriteData(0x1600);
	LCD_WriteCmd(0x0029);LCD_WriteData(0x002D);
	LCD_WriteCmd(0x002B);LCD_WriteData(0x000C);
	delay_ms(50);
	...
	LCD_WriteCmd(0x0030);LCD_WriteData(0x0003);
	LCD_WriteCmd(0x0031);LCD_WriteData(0x0405);
	LCD_WriteCmd(0x0032);LCD_WriteData(0x0204);
	LCD_WriteCmd(0x0035);LCD_WriteData(0x0100);
	LCD_WriteCmd(0x0036);LCD_WriteData(0x1404);
	LCD_WriteCmd(0x0037);LCD_WriteData(0x0305);
	LCD_WriteCmd(0x0038);LCD_WriteData(0x0203);
	LCD_WriteCmd(0x0039);LCD_WriteData(0x0407);
	LCD_WriteCmd(0x003C);LCD_WriteData(0x0001);
	LCD_WriteCmd(0x003D);LCD_WriteData(0x0107);
	
	LCD_WriteCmd(0x0001);LCD_WriteData(0x0000);
	LCD_WriteCmd(0x0003);LCD_WriteData(0x1030);
	LCD_WriteCmd(0x0060);LCD_WriteData(0xA700);
	...
	LCD_WriteCmd(0x0061);LCD_WriteData(0x0001);
...
//  Delay(50);
  ...
  LCD_WriteCmd(0x0022);
	...
	LCD_WriteCmd(0x000F);LCD_WriteData(0x0008);  
	LCD_WriteCmd(0x0011);LCD_WriteData(0x0231);  
	LCD_WriteCmd(0x0012);LCD_WriteData(0x0009);  
	LCD_WriteCmd(0x0013);LCD_WriteData(0x1448);  
	LCD_WriteCmd(0x0010);LCD_WriteData(0x5268);  
	delay_ms(50);	
	LCD_WriteCmd(0x0012);LCD_WriteData(0x0019);  
	delay_ms(50);	
	LCD_WriteCmd(0x0010);LCD_WriteData(0x5260);  
	LCD_WriteCmd(0x0013);LCD_WriteData(0x2d48);  
	delay_ms(50);	
	LCD_WriteCmd(0x0030);LCD_WriteData(0x0000); 
	LCD_WriteCmd(0x0031);LCD_WriteData(0x0501);  
	LCD_WriteCmd(0x0032);LCD_WriteData(0x0207);  
	LCD_WriteCmd(0x0033);LCD_WriteData(0x0502);  
	LCD_WriteCmd(0x0034);LCD_WriteData(0x0007);  
	LCD_WriteCmd(0x0035);LCD_WriteData(0x0601);  
	LCD_WriteCmd(0x0036);LCD_WriteData(0x0707);  
	LCD_WriteCmd(0x0037);LCD_WriteData(0x0305);  
	LCD_WriteCmd(0x0038);LCD_WriteData(0x040e);  
	LCD_WriteCmd(0x0039);LCD_WriteData(0x040e); 
	
	LCD_WriteCmd(0x003a);LCD_WriteData(0x0101);  
	LCD_WriteCmd(0x003b);LCD_WriteData(0x0101);  
	LCD_WriteCmd(0x003c);LCD_WriteData(0x0101);  
	LCD_WriteCmd(0x003d);LCD_WriteData(0x0101);  
	LCD_WriteCmd(0x003e);LCD_WriteData(0x0001);  
	LCD_WriteCmd(0x003f);LCD_WriteData(0x0001);
	 
	LCD_WriteCmd(0x0001);LCD_WriteData(0x011B);  
	LCD_WriteCmd(0x0002);LCD_WriteData(0x0700);  
	LCD_WriteCmd(0x0003);LCD_WriteData(0x1030);  
	LCD_WriteCmd(0x0008);LCD_WriteData(0x1010);  
	LCD_WriteCmd(0x000A);LCD_WriteData(0x4420);  
	LCD_WriteCmd(0x000B);LCD_WriteData(0x5030);  
	LCD_WriteCmd(0x0007);LCD_WriteData(0x0005);  
	LCD_WriteCmd(0x0007);LCD_WriteData(0x0025);  
	LCD_WriteCmd(0x0007);LCD_WriteData(0x0027);  
	LCD_WriteCmd(0x0007);LCD_WriteData(0x0037); 
